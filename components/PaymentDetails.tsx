...
const PaymentDetails = () => {
  ...
  const locationDetails: IFormData[] = [
    {
      name: "pincode",
      type: "number",
      label: "Pincode",
  ...
  return (
    <div className="bg-blue-86">
      ...
      {/* location details */}
      <PreOrderForm title="2/3:Location Details" formData={locationDetails} />
      {/* billing details */}
      ...
      <section className="bg-blue-19 flex flex-col px-5 py-[93px] lg:px-10 lg:flex-row lg:gap-5 lg:py-[193px]">
        ...
        <div className="w-full lg:w-1/2 lg:mt-[165px]">
          {/* booking information */}
          {/* colour */}
          ...
          <div className="mt-[25px] lg:mt-[33px] mb-[93px]">
            ...
            {/* checkbox */}
            <div className="mt-[95px] flex flex-row gap-[39px] items-start">
              <div>
                <input
